...
const styles = StyleSheet.create({
  container: { flex: 1 },
  gymBackground: { resizeMode: "cover" },
  ...
  insideitemImage: { width: 90, height: 80, justifyContent: 'center', alignItems: 'center', resizeMode: 'contain', borderRadius: 15, backgroundColor: '#F9E79F', marginTop: 8 },
