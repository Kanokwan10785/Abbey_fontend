...
const styles = StyleSheet.create({
  ...
  heightText: { position: 'absolute', top: 20, left: '0%', transform: [{ translateX: 50 }], fontSize: 20, color: '#FFF', fontFamily: 'appfont_02', backgroundColor: 'rgba(0, 0, 0, 0.5)', paddingHorizontal: 10, borderRadius: 5 },
  petImages: { width: 198, height: 180 },
  petImage: { width: '95%', height: '95%',top: '35%' },
