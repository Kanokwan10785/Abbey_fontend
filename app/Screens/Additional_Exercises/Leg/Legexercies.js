    ...
    useEffect(() => {
      ...
      const fetchexercises = async () => {
        try {
            ...
            const response = await fetch(`http://192.168.1.196:1337/api/addexercises?filters[exercise][$eq]=Leg&populate=all_exercises.animation,all_exercises.muscle`
            );
